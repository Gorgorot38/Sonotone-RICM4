...
@author: Julian
 ...
 TODO:
     Corriger les parametres associe aux filtres
     Ne prendre que ceux utiles
"""
...
class _Biquad():
    ...
    def __init__(self, type, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
...
class Lowpass(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.LOW_PASS,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Highpass(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.HIGH_PASS,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Bandpass(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.BAND_PASS,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Notch(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.NOTCH,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Allpass(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.ALL_PASS,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Peaking(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.PEAKING,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Lowshelf(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.LOW_SHELF,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
class Highshelf(_Biquad):
    ...
    def __init__(self, freq, dbGain, srate, bandwidthOrQOrS, isBandwidth):
        _Biquad.__init__(self,F.HIGH_SHELF,freq,dbGain,srate,bandwidthOrQOrS,isBandwidth)
...
if __name__ == "__main__":
    lp = Lowpass(100.0,10.0,44100,2.0,False)
    lh = Highpass(100.0,10.0,44100,2.0,False)
